"""Experiment 10c: triple-PureGnn vs LookaheadV3 tournament.

Variant of e10_dual_gnn that swaps Random for a THIRD PureGnn slot, so
we can compare three trained checkpoints against the LookaheadV3 baseline
...
Checkpoint labels are recorded in the run config for downstream analysis.
"""
...
_BASE_SEATING = ["PureGnnA", "PureGnnB", "PureGnnC", "LookaheadMctsV3"]
...
def main(
    *,
    ...
    out = make_run_dir(out_root, "e10c_triple_gnn")
    base_config = {
        "experiment": "e10c_triple_gnn",
